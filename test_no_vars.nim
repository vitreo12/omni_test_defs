...
macro findDeclarableStructs*(typed_code_block : typed, untyped_block_code : untyped, is_perform_block_typed : typed = false) : untyped =
...
macro findDeclarableVariables*(code_block : untyped) : untyped =
    var 
